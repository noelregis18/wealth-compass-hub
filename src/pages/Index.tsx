...
const CalculatorCard: React.FC<CalculatorCardProps> = ({ title, description, icon, to, className = "" }) => (
  <Link to={to}>
    <Card className={`h-full hover:shadow-md transition-all duration-300 hover:border-primary/50 ${className}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-6">
            ...
            <CalculatorCard
              ...
              description="Calculate your mortgage payments and see amortization schedule"
            ...
            <CalculatorCard
              ...
              description="Determine the down payment you need for a property"
              icon={<Wallet className="h-6 w-6 text-primary" />}
              to="/calculator/down-payment"
            />
            <CalculatorCard
              title="Lease Calculator"
              description="Understand your lease payments and total cost"
          ...
          <div className="space-y-6">
            ...
            <CalculatorCard
              ...
              description="Compare simple and compound interest earnings"
          ...
          <div className="space-y-6">
            ...
            <CalculatorCard
              ...
              description="Track potential returns on your mutual fund investments"
              icon={<AreaChart className="h-6 w-6 text-primary" />}
              to="/calculator/mutual-fund"
            />
            <CalculatorCard
              title="Tax Saving Calculator"
              description="Optimize your tax savings through investments"
              icon={<BadgeDollarSign className="h-6 w-6 text-primary" />}
              to="/calculator/tax-saving"
            />
            <CalculatorCard
